 ...
 <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <ul class="navbar-nav">
    ...
    <div class="col-md-4 col-md-offset-4 " id = "frm">  
        <h1>Register</h1>  
        <form name="f1" action = "reg.php" onsubmit = "return validation()" method = "POST">  
            <p>  
            ...
            <p>     
                <input class="tb5 bg-dark text-light" type =  "submit" id = "btn" value = "Register" /> 
                <h4>you will be redirected to Login page after registration</h4>
            </p>  
        </form>  
    </div>     
    <script>  
